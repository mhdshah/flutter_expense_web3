...
import 'package:flutter_expense_dapp/features/dashboard/bloc/dashboard_bloc.dart';
import 'package:flutter_expense_dapp/utils/colors.dart';
      ...
      body: BlocConsumer<DashboardBloc, DashboardState>(
        ...
        builder: (context, state) {
          switch (state.runtimeType) {
            case const (DashboardLoadingState):
              return const Center(
                child: CircularProgressIndicator(),
              );
            case const (DashboardErrorState):
              return const Center(
                child: Text("Error"),
              );
            case const (DashboardSuccessState):
